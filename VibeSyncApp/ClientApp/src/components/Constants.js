...
export const baseUriVibeSync = 'https://localhost:5001/';
...
export const messages = [
    { id: 1, text: "Bhavik on your left table just tipped " },
    { id: 2, text: "Rohit on your right has paid the final payment of " },
    { id: 3, text: "Rahul has successfully completed the payment of " },
    { id: 4, text: "Soham  just finalized his payment of" },
    { id: 5, text: "Tarun just boosted his status with a payment of " },
    { id: 6, text: "Muskan straight ahead just wowed us with a payment of " },
    { id: 7, text: "Harshit has made the final payment of " },
    { id: 8, text: "Daniel just made a big move with a payment of " },
    { id: 9, text: "Harman just stepped up with a payment of "  },
    { id: 10, text: "Sid on your left just raised the bar with a payment of " },
    { id: 11, text: "Shruti just made a statement with a final payment of " }
];
