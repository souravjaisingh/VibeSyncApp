                ...
                {isSpecialAnnouncement ? (
                    <div className="special-announcement-header">
                        ...
                        {isMicAnnouncement && rowData.acceptingRequests && (
                            <>
                                <div className="mic-announcement-buttons">
                                    <button onClick={() => handleButtonClick("Happy Birthday")}>
                                        Happy Birthday
                                    </button>
                                    <button onClick={() => handleButtonClick("Happy Anniversary")}>
                                        Happy Anniversary
                                    </button>
                                    <button onClick={() => handleButtonClick("Congratulations")}>
                                        Congratulations
                                    </button>
                                </div>
                        ...
                        {isScreenAnnouncement && rowData.displayRequests && (
                            <>
                                <div className="mic-announcement-buttons">
                                    <button onClick={() => handleButtonClick1("Happy Birthday")}>
                                        Happy Birthday
                                    </button>
                                    <button onClick={() => handleButtonClick1("Happy Anniversary")}>
                                        Happy Anniversary
                                    </button>
                                    <button onClick={() => handleButtonClick1("Congratulations")}>
                                        Congratulations
                                    </button>
                                </div>
