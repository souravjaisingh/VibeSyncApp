                ...
                {mobileNo === null ? (<div className='mobile-number-container'>
                  <div>
                    <img className='user-image-icon-lander' src="images/user_image_lander.png" />
                      <input id="mobile-no" type="tel" pattern="[0-9]*" inputMode="numeric" className='mobile-number-input' placeholder='Mobile Number' autocomplete="new-password" name="mobile-no-random" />
                  </div>
